...
public class Vehicle_Fire extends Vehicle {

	double  CurrentTick , EndofCurrentAction ;	
	ISchedule schedule = RunEnvironment.getInstance().getCurrentSchedule(); 

	//-------------------------------------
	public Station_Fire AssignedStation=null;
	...
	public ArrayList<Responder_Fire> Responders_list=new ArrayList<Responder_Fire>();	


	//----------------------------------------------------------------------------------------------
	public Vehicle_Fire(Context<Object> context, Geography<Object> geography, Coordinate Location,String Nodename_initialLocation,RoadNode _Node , String ID, int speed ,Station_Fire _AssignedStation) {
	...
	//********************************************************************************
	public void AssigenResponder(Responder_Fire Resp  ){
	...
	public void update_postion(Coordinate new_position) {
		...
		if ( Move_responderOrDriver )
			for( Responder_Fire Resp : Responders_list)
	...
	public boolean Check_FirstArrivalFire (  ) 
	{
		boolean result=false;

		if (this.AssignedDriver.assignedIncident.FirstArival_Fire ) 
		{result=true;this.AssignedDriver.assignedIncident.FirstArival_Fire =false;}	
	...
	//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	//
	//@ScheduledMethod(start = 1, interval = 1 , priority= 24)
	public void step() {
		...
		{		 
			...
			EndofCurrentAction=  InputFile.perpration_duration_fr  + this.perpration_delay ;   
		...
		{ 			
			...
			FirstArrivalofVehicleAgency= this.Check_FirstArrivalFire() ;
